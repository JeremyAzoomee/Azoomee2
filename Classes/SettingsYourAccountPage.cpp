...
void SettingsYourAccountPage::onEnter()
{
    ...
    Label* logout = Label::createWithTTF("Log out", Style::Font::Medium, 75);
    ...
    Label* privacy = Label::createWithTTF("Privacy Policy", Style::Font::Medium, 75);
    ...
    Label* terms = Label::createWithTTF("Terms of Use", Style::Font::Medium, 75);
