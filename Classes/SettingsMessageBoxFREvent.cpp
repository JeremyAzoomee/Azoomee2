...
void SettingsMessageBoxFREvent::onEnter()
{
    ...
    _heading->setPosition(Vec2(_messageBox->getContentSize().width * 0.5f, _messageBox->getContentSize().height * 0.77f));
	_heading->setOverflow(Label::Overflow::SHRINK);
	_heading->setDimensions(_messageBox->getContentSize().width * 0.75f, _messageBox->getContentSize().height * 0.1f);
    ...
    _subHeading->setPosition(Vec2(_messageBox->getContentSize().width * 0.5f, _messageBox->getContentSize().height * 0.66));
	_subHeading->setOverflow(Label::Overflow::SHRINK);
	_subHeading->setDimensions(_messageBox->getContentSize().width * 0.75f, _messageBox->getContentSize().height * 0.19f);
    ...
    _textInputHeading->setPosition(Vec2(_messageBox->getContentSize().width * 0.5f, _messageBox->getContentSize().height * 0.46f));
	_textInputHeading->setOverflow(Label::Overflow::SHRINK);
	_textInputHeading->setDimensions(_messageBox->getContentSize().width * 0.75f, _messageBox->getContentSize().height * 0.1f);
    _messageBox->addChild(_textInputHeading);
    
    _textInput = TextInputLayer::createSettingsBoxTextInput(1090, INPUT_IS_KIDS_CODE);
    _textInput->setCenterPosition(Vec2(_messageBox->getContentSize().width * 0.5f, _messageBox->getContentSize().height * 0.32f));
    ...
    _sendButton->setPosition(Vec2(_messageBox->getContentSize().width * 0.5f, _messageBox->getContentSize().height * 0.18f));
