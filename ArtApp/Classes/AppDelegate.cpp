...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("azoomee2_ArtApp", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("azoomee2_ArtApp");
#endif
    ...
    FileUtils::getInstance()->addSearchPath("res/artIcons");
    ...
    auto scene = ArtAppBase::createScene();
